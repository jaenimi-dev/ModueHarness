...
**ModueHarness**는 Claude Code, Google Antigravity(AGY), OpenAI ChatGPT Codex, Aider 등 다양한 AI CLI 도구들을 하나의 유기적인 팀으로 엮어 소프트웨어 엔지니어링 작업을 자율적·협업적으로 해결하는 Multi-AI CLI 하네스(Harness) 프레임워크입니다.
